...
print(f"error    : {abs(r.load - analytical):.2e}")
...
print(f"error    : {abs(outer.load - analytical2):.2e}")
...
print(f"error    : {abs(r.load - analytical3):.2e}")
...
print(f"val == load: {abs(e.val - e.load) < 1e-12}")
...
print(f"error: {abs(deriv.load - 4.0):.2e}")
...
print(f"root of x²−2:   {result:.10f}  "
      ...
      f"error: {abs(result - math.sqrt(2)):.2e}")
...
print(f"root of exp(x)−3: {result3:.10f}  "
      ...
      f"error: {abs(result3 - math.log(3)):.2e}")
